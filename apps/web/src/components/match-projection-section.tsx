...
import type { ProiezioniDellaGara } from "@/server/iqstats/projection-runtime";
...
function Voce({ chi, atteso, linee }: {
  readonly chi: string;
...
function Bersaglio({ bersaglio, casa, trasferta }: {
  ...
  return (
    <li className="engine-row">
      ...
      <ul className="engine-splits">
        <Voce chi={casa} atteso={lCasa.valoreAtteso} linee={bersaglio.linee.casa} />
        <Voce chi={trasferta} atteso={lTrasferta.valoreAtteso} linee={bersaglio.linee.trasferta} />
